  ...
  return <header className="globalHeader">
    <div className="utilityBar">
      ...
      <nav className="utilityNav" aria-label="Utility Navigation">
        ...
        <div className="navMenu"><button className="navMenuButton" type="button">Calculators <span>⌄</span></button><div className="navDropdown"><a href="https://steel.linkoteq.com/">W-Section</a></div></div>
      </nav>
      <div className="navMenu signInMenu"><button className="navCta navMenuButton" type="button">Sign In <span>⌄</span></button><div className="navDropdown signInDropdown"><a href="https://timesheet.linkoteq.com/">Employee Login</a><a href="https://linkoteq.com/customer-login">Customer Login</a></div></div>
    </div>
